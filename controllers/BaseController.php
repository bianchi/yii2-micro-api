...
class BaseController extends ActiveController
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['corsFilter'] = [
            ...
            ['Origin' => ['*'], 'Access-Control-Request-Method' => ['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'HEAD', 'OPTIONS'], 'Access-Control-Request-Headers' => ['*'], 'Access-Control-Allow-Credentials' => true, 'Access-Control-Max-Age' => 86400, 'Access-Control-Expose-Headers' => []]
            // 'cors' => [
            //     [
